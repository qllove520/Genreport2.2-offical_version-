...
class ExcelWorker(QThread):
    ...
    def __init__(self, doc1_path, doc2_path, doc3_path, doc4_path, target_report_path,
        ...
        self.append_mode_doc1 = append_mode_doc1
        self.append_mode_doc2 = append_mode_doc2
        self.append_mode_doc3 = append_mode_doc3
    ...
    def run(self):
        try:
            ...
            success = consolidate_excel_data_and_insert_chart(
                ...
                append_mode_doc1=self.append_mode_doc1,
                append_mode_doc2=self.append_mode_doc2,
                append_mode_doc3=self.append_mode_doc3,
